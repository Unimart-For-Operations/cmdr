...
# hosts (dankcolors) and use Ghostty's stock theme elsewhere.
...
in
{
  ...
  xdg.configFile."ghostty/config".text = ''
    ...
    # Font settings — use mono family and size from shared fonts for metric parity
    ...
    # Line spacing for better vertical rhythm and readability (from fonts)
    adjust-cell-height = ${toString f.cellHeightPercent}%

    # Appearance — DMS hosts use DMS's matugen-generated dankcolors theme,
    # otherwise Ghostty's stock theme
